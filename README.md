...
|---|---|
| [FRONTEND_IMPLEMENTATION_RULES.md](./FRONTEND_IMPLEMENTATION_RULES.md) | Philosophy, framework choice, project structure, atomic design |
| [COMPONENT_PATTERNS.md](./COMPONENT_PATTERNS.md) | Authoring, light DOM, styling, layout engine, JSDoc typing |
| [STATE_AND_ROUTING.md](./STATE_AND_ROUTING.md) | Store, routing, unified app state, realtime SSE sync |
| [CONVENTIONS.md](./CONVENTIONS.md) | Naming rules, anti-patterns |
| [SERVER_AND_DEPS.md](./SERVER_AND_DEPS.md) | Express server, import maps, vendor dependency loading |
| [BACKEND_API_SPEC.md](./BACKEND_API_SPEC.md) | REST CRUD, JSON Schema via HEAD, entity management |
| [TESTING.md](./TESTING.md) | Testing philosophy, tools, patterns, phase checkpoints |
